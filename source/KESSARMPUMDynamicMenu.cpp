...
// RtMouseDefault
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_RtMouseDefaultMenuItem = {
	78350,
	78349,
	78348,
	78351,
...
// RtMouseLayout
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_RtMouseLayoutMenuItem = {
	78691,
	78845,
	78612,
	78815,
...
// RtMouseText
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_RtMouseTextMenuItem = {
	78691,
	78846,
	78612,
	78815,
...
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_RtMouseTextSubMenuPath = {
...
// RtMouseTable
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_RtMouseTableMenuItem = {
	78636,
	66880,
	66881,
	66882,
...
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_RtMouseTableSubMenuPath = {
	"RtMouseTable:Rotate:",
...
// ShiftRtMouseDefault
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_ShiftRtMouseDefaultMenu = {};
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_ShiftRtMouseDefaultMenuPath = {};

// ShiftRtMouseLayout
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_ShiftRtMouseLayoutMenu = {};
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_ShiftRtMouseLayoutMenuPath = {};

// ShiftRtMouseText
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_ShiftRtMouseTextMenu = {};
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_ShiftRtMouseTextMenuPath = {};

// ShiftRtMouseTable
std::vector<ActionID> KESSARMPUMDynamicMenu::vector_ActionID_ShiftRtMouseTableMenu = {};
std::vector<PMString> KESSARMPUMDynamicMenu::vector_PMString_ShiftRtMouseTableMenuPath = {};
...
void KESSARMPUMDynamicMenu::RebuildMenu(ActionID dynamicActionID, IPMUnknown* widget)
{
	do {
		...
		switch (dynamicActionID.Get())
		{
			...
			case kKESSARMPUMRtMouseTextDynMnuPlaceholderActionID: // RtMouseText
			{
			...
			case kKESSARMPUMRtMouseTableDynMnuPlaceholderActionID: // RtMouseTable
			{
				KESSARMPUMDynamicMenu::enum_PopUpMenuName = KESSARMPUMDynamicMenu::kKESSARMPUMRtMouseTable;
...
void KESSARMPUMDynamicMenu::MenuCustomization(
